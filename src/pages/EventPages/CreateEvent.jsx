...
function CreateEvent(){
  ...
  const handleFileUpload = (e) => {
    ...
    <div class="max-w-lg mx-auto my-10 bg-white p-8 rounded-xl shadow shadow-slate-300">
        <h1 class="text-4xl font-medium">Add Event</h1>
        ...
        <form onSubmit={handleSubmit} class="my-10">
            <div class="flex flex-col space-y-5">
                ...
                <label for="address">
                    ...
                    <input id="address" name="address" type="text" class="w-full py-3 border border-slate-200 rounded-lg px-3 focus:outline-none focus:border-slate-500 hover:shadow" placeholder="Enter a short description about yourself" value={address} onChange={handleAddress} />
                </label>
                <label for="fileUrl">
